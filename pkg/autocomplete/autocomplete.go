...
// autocompleteDB holds static suggestion lists keyed by command. These
// are display-only conveniences for the editor; the parser itself does
// not consult them.
...
// GetSuggestions returns autocomplete suggestions for a given command
// and partial query. For "rx" it delegates to engine.SearchDrugs.
